...
3. **Endpoint URL:** `https://your-domain.com/api/payments/stripe-webhook`
   - For development: `https://theme-fix-admin.preview.emergentagent.com/api/payments/stripe-webhook`
...
FRONTEND_URL="https://theme-fix-admin.preview.emergentagent.com"
```
