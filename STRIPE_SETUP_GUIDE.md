...
3. **Endpoint URL:** `https://your-domain.com/api/payments/stripe-webhook`
   - For development: `https://login-system-check-1.preview.emergentagent.com/api/payments/stripe-webhook`
...
FRONTEND_URL="https://login-system-check-1.preview.emergentagent.com"
```
