...
3. **Endpoint URL:** `https://your-domain.com/api/payments/stripe-webhook`
   - For development: `https://appollo-clone-ui.preview.emergentagent.com/api/payments/stripe-webhook`
...
FRONTEND_URL="https://appollo-clone-ui.preview.emergentagent.com"
```
