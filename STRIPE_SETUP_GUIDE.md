...
3. **Endpoint URL:** `https://your-domain.com/api/payments/stripe-webhook`
   - For development: `https://seo-audit-sync-1.preview.emergentagent.com/api/payments/stripe-webhook`
...
FRONTEND_URL="https://seo-audit-sync-1.preview.emergentagent.com"
```
