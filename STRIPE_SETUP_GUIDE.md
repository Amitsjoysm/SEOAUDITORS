...
3. **Endpoint URL:** `https://your-domain.com/api/payments/stripe-webhook`
   - For development: `https://theme-audit-fix.preview.emergentagent.com/api/payments/stripe-webhook`
...
FRONTEND_URL="https://theme-audit-fix.preview.emergentagent.com"
```
