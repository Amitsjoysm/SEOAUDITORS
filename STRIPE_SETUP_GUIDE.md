...
3. **Endpoint URL:** `https://your-domain.com/api/payments/stripe-webhook`
   - For development: `https://frontend-syntax-fix-1.preview.emergentagent.com/api/payments/stripe-webhook`
...
FRONTEND_URL="https://frontend-syntax-fix-1.preview.emergentagent.com"
```
