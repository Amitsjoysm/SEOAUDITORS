...
3. **Endpoint URL:** `https://your-domain.com/api/payments/stripe-webhook`
   - For development: `https://codebase-sync-49.preview.emergentagent.com/api/payments/stripe-webhook`
...
FRONTEND_URL="https://codebase-sync-49.preview.emergentagent.com"
```
