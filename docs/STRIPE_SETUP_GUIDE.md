...
3. **Endpoint URL:** `https://your-domain.com/api/payments/stripe-webhook`
   - For development: `https://insight-troubleshoot.preview.emergentagent.com/api/payments/stripe-webhook`
...
FRONTEND_URL="https://insight-troubleshoot.preview.emergentagent.com"
```
