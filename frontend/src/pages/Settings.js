                ...
                <div className="bg-white rounded-xl border border-gray-200 p-8">
                  ...
                  <form onSubmit={handleUpdateProfile} className="space-y-6">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="bg-purple-500 hover:bg-purple-600 text-gray-900 px-8 py-3 rounded-lg font-semibold transition-colors disabled:opacity-50"
                    >
              ...
              {activeTab === 'subscription' && (
                <div className="bg-white rounded-xl border border-gray-200 p-8">
                  ...
                  <button
                    ...
                    className="bg-purple-500 hover:bg-purple-600 text-gray-900 px-8 py-3 rounded-lg font-semibold transition-colors"
                  >
                    View Plans
                  </button>
                </div>
